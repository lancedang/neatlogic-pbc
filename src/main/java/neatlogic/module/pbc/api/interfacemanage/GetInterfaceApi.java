...
public class GetInterfaceApi extends PrivateApiComponentBase {
    ...
    @Input({@Param(name = "id", type = ApiParamType.STRING, desc = "接口ID")})
    @Output({@Param(explode = InterfaceVo.class)})
    @Description(desc = "查询人行接口详细信息")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        return interfaceMapper.getInterfaceById(paramObj.getString("id"));
    }
