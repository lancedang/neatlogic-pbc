...
public class GetPropertyApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取属性详情")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        return propertyMapper.getPropertyByUid(paramObj.getLong("uid"));
    }
}
