...
public class ListPropertyDataTypeApi extends PrivateApiComponentBase {
    ...
    public String getToken() {
        return "/pbc/interface/property/datatype/list";
    }
    ...
    @Description(desc = "获取属性数据类型列表接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        return propertyMapper.getPropertyDataTypeList();
    }
