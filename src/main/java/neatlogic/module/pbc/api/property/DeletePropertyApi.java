...
public class DeletePropertyApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "删除属性接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        propertyMapper.deletePropertyByUid(paramObj.getLong("uid"));
        return null;
    }
}
