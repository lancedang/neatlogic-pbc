...
public class ListPropertyRestraintApi extends PrivateApiComponentBase {
    ...
    public String getToken() {
        return "/pbc/interface/property/restraint/list";
    }
    ...
    @Description(desc = "获取属性约束列表接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        return propertyMapper.getPropertyRestraintList();
    }
