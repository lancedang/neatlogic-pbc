...
public class GetInterfaceItemApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取单条接口数据接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        Long id = paramObj.getLong("id");
        return interfaceItemMapper.getInterfaceItemById(id);
    }
