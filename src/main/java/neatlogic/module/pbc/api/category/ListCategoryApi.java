...
public class ListCategoryApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取分类标识列表接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        return categoryMapper.getCategoryByInterfaceId(paramObj.getString("interfaceId"));
    }
