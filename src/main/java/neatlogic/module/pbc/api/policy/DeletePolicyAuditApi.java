...
public class DeletePolicyAuditApi extends PrivateApiComponentBase {
    ...
    public String getToken() {
        return "/pbc/policy/audit/delete";
    }
    ...
    @Description(desc = "删除同步策略执行记录接口")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        policyMapper.deletePolicyAudit(paramObj.getLong("id"));
        return null;
    }
}
