...
@Component
public class InterfaceItemCustomFileHandler extends FileTypeHandlerBase {
    private final Logger logger = LoggerFactory.getLogger(InterfaceItemCustomFileHandler.class);
    ...
    public String getName() {
        return "PBC_INTERFACE_ITEM_CUSTOM";
    }
